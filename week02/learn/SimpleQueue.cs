public class SimpleQueue
{
    ...
    {
        _queue.Add(value);  // FIXED: Changed from Insert(0, value) to Add(value)
    }
    ...
    private int Dequeue()
    {
        ...
        var value = _queue[0];  // FIXED: Changed from [1] to [0]
        _queue.RemoveAt(0);     // FIXED: Changed from RemoveAt(1) to RemoveAt(0)
        return value;
    }
}